    ...
    return SafeArea(
      ...
      return Container(
              ...
              decoration: BoxDecoration(
                color:
                    Get.find<ThemeController>().isDarkMode.value? AppColor.darkModeBackgroundColor : null,
